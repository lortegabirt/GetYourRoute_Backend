...
public interface ItineraryRepository extends MongoRepository<Itinerary, String>, ItineraryRepositoryCustom  {
	...
	Page<Itinerary> findByNameExpr(String reg, Pageable pageable);
	...
	Page<Itinerary> findByBeginDateEndDate(LocalDateTime beginDate, LocalDateTime endDate, Pageable pageable);
